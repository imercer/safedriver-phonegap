if (document.location.host.indexOf('.dev') > -1) {
    ...
    if (document.location.host.indexOf('metroui') > -1) {
        ...
        document.write("<script type="text/javascript" src='http://c.hit.ua/hit?i=98055&g=0&x=3&r="+encodeURI(document.referrer)+"&u="+encodeURI(window.location.href)+"'></script>");
    } else {
